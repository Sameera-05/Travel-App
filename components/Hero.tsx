  ...
  return (
    ...
    md:gap-28 lg:py-20 xl:flex-row">
      ...
      <div className="relative z-20 flex flex-1 flex-col xl:w-1/2"> 
        ...
        <p className="regular-16 mt-16 text-gray-30 xl:max-w-[520px]"> We want to be on each of your journeys seeking the satisfaction of seeing the incorruptible beauty of nature. 
        ...
        <div className="my-11 flex flex-wrap gap-5">
          ...
          <p className="bold-16 lg:bold-20 text-blue-70">
            ...
            <span className="regular-16 lg:reglar-20 ml-1">Excellent Reviews</span>
